  ...
  const handleSubmitRecharge = async () => {
    ...
    try {
      ...
      const result = await WalletService.requestDeposit(
        ...
        `USDT_${Date.now()}`,
        "usdt", // Especificar tipo de método de pago
      );
      ...
      // Navegar a la pantalla de instrucciones de pago USDT
      navigation.navigate("USDTPaymentInstructions", {
        amount: amount,
        paymentMethod: paymentMethod || {
          account_info: {
            network: "TRC20",
            wallet_address: "Contactar soporte",
            currency: "USDT",
          },
        },
      ...
      console.error("❌ Error submitting USDT recharge:", error);
      Alert.alert(
        "Error",
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.warningBox}>
            ...
            <Text style={styles.warningText}>
              <Text style={styles.warningBold}>Importante:</Text> Asegúrate de
              enviar USDT únicamente a través de la red TRC20. Envíos por otras
              redes no serán procesados.
            </Text>
          </View>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Recibirás la dirección de wallet después de confirmar tu
              solicitud. El administrador procesará tu recarga una vez
              confirmada la transacción en la blockchain.
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
