...
const LoginScreen = () => {
  ...
  return (
    <>
      ...
      >
        {/* Patrón de fondo de campo de fútbol - Fixed background */}
          ...
          <Animated.View style={[styles.formContainer, formTransform]}>
            <View style={styles.formCard}>
              ...
              {!isLogin && (
                <>
                  ...
                  <View
                    style={[
                      styles.inputContainer,
                      focusedInput === "invitationCode" && styles.inputFocused,
                    ]}
                  >
                    <Ionicons name="qr-code" size={22} color="#3182ce" />
                    <TextInput
                      ref={invCodeRef}
                      style={styles.input}
                      ...
                      autoCorrect={false}
                      onFocus={() => {
                        setFocusedInput("invitationCode");
                        scrollToInput(invCodeRef);
                      }}
                      onBlur={() => setFocusedInput(null)}
                    />
                  </View>
              ...
              >
                <LinearGradient
                  colors={
                    loading ? ["#a0aec0", "#718096"] : ["#38a169", "#2d7d32"]
                  }
              ...
              {/* Botón de autenticación biométrica - solo en modo login */}
              {isLogin &&
                isBiometricSupported &&
                isBiometricEnabled &&
                !loading && (
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <Text style={styles.authButtonText}>
                        🔒 Ingresar con {getBiometricTypeText()}
                      </Text>
                    </LinearGradient>
                  </TouchableOpacity>
                )}
