...
const BankTransferScreen = ({ navigation }) => {
  ...
  const BANKS = [
    { id: 1, name: 'Banco Banreservas', icon: '🏦', color: '#ef4444' },
    { id: 2, name: 'Banco Popular Dominicano', icon: '🏦', color: '#3b82f6' },
    { id: 3, name: 'Banco BHD', icon: '🏦', color: '#f59e0b' },
  ];
  ...
  const handleSubmitRecharge = async () => {
    ...
    try {
      ...
      const bankInfo = paymentMethod?.account_info;
      Alert.alert(
        '✅ Solicitud Enviada',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Recibirás las instrucciones de pago después de confirmar tu solicitud.
          </Text>
        </View>
      </ScrollView>
    </View>
